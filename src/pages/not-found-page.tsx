...
export function NotFoundPage() {
  return (
    <div className="mx-auto max-w-2xl rounded-[32px] border border-white/10 bg-white/5 p-10 text-center">
      <p className="text-sm uppercase tracking-[0.24em] text-amber-300/80">404</p>
      ...
      <Link
        to="/"
        className="mt-8 inline-flex rounded-full bg-white px-5 py-3 font-semibold text-slate-950 transition hover:bg-amber-200"
      >
        Go home
      </Link>
    </div>
